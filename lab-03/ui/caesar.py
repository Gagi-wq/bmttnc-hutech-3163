...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(487, 336)
        self.centralwidget = QtWidgets.QWidget(MainWindow)
        self.centralwidget.setObjectName("centralwidget")
        self.label = QtWidgets.QLabel(self.centralwidget)
        self.label.setGeometry(QtCore.QRect(170, 0, 161, 16))
        ...
        self.PlainText.setGeometry(QtCore.QRect(80, 50, 361, 61))
        self.PlainText.setObjectName("PlainText")
        self.KeyText = QtWidgets.QPlainTextEdit(self.centralwidget)
        self.KeyText.setGeometry(QtCore.QRect(80, 130, 371, 31))
        self.KeyText.setObjectName("KeyText")
        self.CipherText = QtWidgets.QPlainTextEdit(self.centralwidget)
        self.CipherText.setGeometry(QtCore.QRect(80, 180, 371, 71))
        ...
        self.Encrypt.setGeometry(QtCore.QRect(90, 270, 75, 23))
        self.Encrypt.setObjectName("Encrypt")
        self.Decrypt = QtWidgets.QPushButton(self.centralwidget)
        self.Decrypt.setGeometry(QtCore.QRect(370, 270, 75, 23))
        self.Decrypt.setObjectName("Decrypt")
        self.label_5 = QtWidgets.QLabel(self.centralwidget)
        self.label_5.setGeometry(QtCore.QRect(120, 20, 251, 21))
        font = QtGui.QFont()
        font.setPointSize(9)
        font.setBold(True)
        font.setWeight(75)
